...
function getBooksBorrowedCount(books) {
  // Use the filter method to get an array of books with unreturned borrows
  const borrowedBooks = books.filter(book => !book.borrows[0].returned);
  // Return the length of the borrowedBooks array, which represents the count of borrowed books
